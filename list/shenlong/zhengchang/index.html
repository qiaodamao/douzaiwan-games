...
<head>
    ...
    <style>
        /* 扫码进群区域 - 始终显示在左上角 */
        .reward-container {
            position: fixed; /* 使用fixed确保始终在视口左上角 */
            top: 10px;
            left: 10px;
            z-index: 99999; /* 极高的z-index确保不被任何元素遮挡 */
        ...
        .reward-avatar {
            ...
            box-shadow: 0 2px 8px rgba(255,0,102,0.6);
            object-fit: cover;
            cursor: pointer;
            transition: transform 0.3s ease;
            background: white; /* 添加背景色防止透明 */
        }
        .reward-avatar:hover {
            transform: scale(1.1);
        }
...
<!-- 判断浏览器是否屏蔽广告 -->
<script src="http://demo.jb51.net/js/2015/adview_pic_cpc_cpm_cpa_guanggao_gg_ads_300x250.js" type="text/javascript">
</script>
...
<script type="text/javascript">
    ...
    function updateLabView(t) {
        ...
        timer = setInterval(function () {
            ...
            loadintT.innerHTML = '游戏加载中......' + parseInt(tempSeconds) + '%';
            switch (tempSeconds) {
    ...
    // 移除所有游戏结束监听逻辑，不再控制rewardContainer的显示/隐藏
    // 改为：每30秒确保一次进群区域显示（防止某些游戏逻辑修改了样式）
...
<!-- 果盘合合 -->
<script async data-ad-client="ca-pub-3932234672445376" data-ad-channel="1828757928" data-ad-frequency-hint="15s"
